...
export type Project = { number: string; title: string; description: string; disciplines: string; category: string; year: string; status: string; visual: MediaPlaceholderVariant };
...
export const facilities: Facility[] = [
  "Espacio de trabajo", "Laboratorio de electrónica", "Estación de medios", "Cocina", "Patio", "Centro de General Madariaga",
].map((label, index) => ({ number: String(index + 1).padStart(2, "0"), label }));

export const projects: Project[] = [
  { number: "P—01", title: "Cernunnos", category: "Inteligencia territorial", year: "2026", status: "En desarrollo", description: "Una plataforma de inteligencia territorial que transforma datos dispersos en mejores decisiones para gobiernos y comunidades.", disciplines: "Producto · Datos · Territorio", visual: "field" },
  { number: "P—02", title: "Huellas de los Pioneros", category: "Archivo vivo", year: "2026", status: "Investigación activa", description: "Un archivo vivo que recupera historias, documentos y recorridos para conectar la memoria local con nuevas generaciones.", disciplines: "Investigación · Archivo · Cultura", visual: "halftone" },
];
...
export const socialLinks: SocialLink[] = [
  { label: "Instagram", href: "#" }, { label: "LinkedIn", href: "#" }, { label: "GitHub", href: "#" }, { label: "YouTube", href: "#" },
];
